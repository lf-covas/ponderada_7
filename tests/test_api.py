...
def test_verifica_email(db):
    ...
    email_cadastrado = 'gabriel_bomdemais@gmail.com'
    assert UsuarioRepository.verifica_email(db, email_novo) is False
    assert UsuarioRepository.verifica_email(db, email_cadastrado) is True
